...
import com.microservices.demo.kafka.avro.model.*;
import com.microservices.demo.kafka.producer.config.service.*;
...
public class TwitterKafkaStatusListener extends StatusAdapter {
    ...
    public void onStatus(Status status) {
        LOG.info("Received status {} sending to kafka topic {}", status.getText(), kafkaConfigData.getTopicName());
